...
const Hero = () => {
  return (
    <section
      id="home"
      className="bg-gradient-to-b from-teal-500 to-teal-1000 text-white h-screen flex flex-col justify-center items-center text-center px-4 pt-24"
    >
      <h1 className="text-5xl font-extrabold">Ayomide Samuel Ojo</h1>
      <h2 className="text-2xl mt-4 font-semibold italic">
