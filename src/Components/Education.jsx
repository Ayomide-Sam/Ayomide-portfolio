...
const Education = () => {
  return (
    <section
      id="education"
      className="section-offset bg-white px-8 py-20 text-gray-800"
    >
      <div className="max-w-4xl mx-auto">
        <h2 className="text-3xl font-bold text-center mb-12 text-navy">
          Education
        </h2>
        <div className="bg-gray-100 rounded-xl shadow-lg p-8 md:p-12 transition-all duration-300 hover:shadow-2xl">
          <h3 className="text-2xl font-semibold text-teal-700">Babcock University</h3>
          <p className="text-lg mt-2 font-medium">B.Sc. in Computer Information Systems (2022 – 2025)</p>
          {/* <p className="text-md text-gray-600 mb-4">Graduated with First Class Honors</p> */}
          ...
          {/* <p className="mt-4 text-gray-700 leading-relaxed text-justify">
            ...
            was a pivotal experience that deepened my appreciation for solving user-centered problems through technology.
          </p> */}
